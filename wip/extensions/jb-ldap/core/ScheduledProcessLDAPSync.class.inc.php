 ...
 */
class ScheduledProcessLDAPSync implements \iScheduledProcess
{
...
//			$iSeconds = (array_key_exists(3, $aMatches)) ? $aMatches[3] : 0;
	...
	public function Process($iTimeLimit) {
		...
		try {
			...
			$oLDAPSyncProcessor = new \jb_itop_extensions\ldap_sync\LDAPSyncProcessor;
			$oLDAPSyncProcessor->ProcessLDAPs();
